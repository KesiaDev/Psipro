package com.psipro.app.adapters
...
import com.psipro.app.databinding.ItemAttachmentBinding
import java.io.File
    ...
    inner class ViewHolder(
        ...
        fun bind(item: AttachmentItem) {
            ...
            val iconRes = when (item.type) {
                AttachmentType.IMAGE -> com.psipro.app.R.drawable.ic_camera_alt
                AttachmentType.AUDIO -> com.psipro.app.R.drawable.ic_mic
            }
