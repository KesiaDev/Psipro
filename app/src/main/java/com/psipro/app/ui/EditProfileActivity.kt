...
class EditProfileActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Inicializar a tela diretamente sem verificação de autenticação restritiva
        android.util.Log.d("EditProfileActivity", "Iniciando EditProfileActivity")
    ...
    private fun salvarDadosLocais() {
        ...
        val prefs = getSharedPreferences("settings", MODE_PRIVATE)
        prefs.edit().apply {
            putString("profile_name", binding.editTextName.text.toString())
            putString("profile_crp", binding.editTextCRP.text.toString())
