...
export class DashboardController {
  ...
  @Get('metrics')
  getMetrics(@CurrentClinicId() clinicId: string | undefined) {
    return this.dashboardService.getMetrics(clinicId);
  }

  @Get('agenda-summary')
  getAgendaSummary(@CurrentClinicId() clinicId: string | undefined) {
    return this.dashboardService.getAgendaSummary(clinicId);
  }

  @Get('finance-summary')
  getFinanceSummary(@CurrentClinicId() clinicId: string | undefined) {
